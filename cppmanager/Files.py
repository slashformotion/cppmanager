...
class Module():
    def __init__(self, det, module_suffix, main_suffix): # det is modulename::namespacename
    ...
    def deploy(self, path_init):
        ...
        with path.open("w") as f:
            if self.namespace != None:
                id = "_".join([self.module_name.upper(),self.namespace.upper(), self.module_suffix.upper()])
            else:
